 ...
 * well.
 */
public class LoginActivity extends Activity implements UsersDownloaderDelegate {
	 ...
	 */
	private UsersDownloader mUsersDownloader = null;
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			showProgress(true);
			mUsersDownloader = new UsersDownloader(this,mEmail,mPassword);
			mUsersDownloader.execute((Void) null);
		}
	}
